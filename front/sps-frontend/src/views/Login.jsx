...
import clave from '../assets/llave.svg'
...
return (
    <div className='body-login'>
        <div className="h-screen bg-gradient-to-br from-blue-200 to-cyan-200 flex justify-center items-center w-full">
        <form method='POST' className='form-container' onSubmit={handleLogin}>
            <div className="bg-white px-10 py-8 rounded-xl w-screen shadow-xl max-w-sm">
                <div className="space-y-4">
                    <img src="/sps_logo.svg" alt="SPS Logo" className='mx-auto w-8 flex'/>
                    <h1 className="text-center text-2xl font-semibold text-gray-600">Login</h1>
                    <hr/>
                    <label htmlFor="username">
                        <div className="flex items-center border-2 py-2 px-3 rounded-md mb-4">
                        <img src={usuario} alt="Usuario_icono" className="h-5 w-5 text-gray-400"/>
                        <input className="pl-2 outline-none border-none w-full" type="text" id="username" name="user" value={username} placeholder='Usuario' required  onChange={(e) => setUsername(e.target.value)} />
                        </div>
                    </label>
                </div>
                <div>
                    <label htmlFor="password">
                        ...
                        <img src={clave} alt="Clave_icono" className="h-5 w-5 text-gray-400"/>
                        <input className="pl-2 outline-none border-none w-full" type="password" name="password" id="password" value={password} placeholder='Contraseña' required onChange={(e) => setPassword(e.target.value)}/>
                        </div>
                    </label> 
                </div>
            <button type="submit" value="login" id="login" className="mt-6 w-full shadow-xl bg-gradient-to-tr from-blue-600 to-cyan-400 hover:to-blue-800 text-indigo-100 cursor-pointer py-2 rounded-md text-lg tracking-wide transition duration-1000">Entrar</button>
            </div>
        </form>
        </div>
    </div>
